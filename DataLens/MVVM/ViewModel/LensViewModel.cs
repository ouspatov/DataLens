...
namespace DataLens.MVVM.ViewModel
{
    public class LensViewModel : ObservableObject
    {
        ...
        private decimal _last1MonthTotal;
        private decimal _last2MonthTotal;
        private decimal _last3MonthTotal;

        public decimal Last1MonthTotal {
            get => _last1MonthTotal;
            set => SetProperty(ref _last1MonthTotal, value);
        }

        public decimal Last2MonthTotal
        {
            get => _last2MonthTotal;
            set => SetProperty(ref _last2MonthTotal, value);
        }

        public decimal Last3MonthTotal
        {
            get => _last3MonthTotal;
            set => SetProperty(ref _last3MonthTotal, value);
        }
